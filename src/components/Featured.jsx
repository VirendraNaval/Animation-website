    ...
    <div className='w-full py-20'>
        ...
        <div className='px-20'>
            <div className='cards w-full flex gap-20 mt-20'>
                ...
                <div className='cardcontainer w-1/2 h-[75vh] '>
                    <div className='card w-full h-full rounded-2xl bg-green-500 overflow-hidden'>
                        <img className='w-full h-full bg-cover' src="http://ochi.design/wp-content/uploads/2022/04/logo001.svg" alt="http://ochi.design/wp-content/uploads/2023/10/Fyde_Illustration_Crypto_2-1326x1101.png" />
                    </div>
                </div>
             </div>
        </div>
